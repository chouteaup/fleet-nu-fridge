...
echo -e "  ${GREEN}1.${NC} ./setup.sh dev"
echo -e "  ${GREEN}2.${NC} ./monitor.sh"
echo -e "  ${GREEN}3.${NC} Edit src/Dashboard.jsx"
echo -e "  ${GREEN}4.${NC} See changes on http://localhost:5173"
echo -e "  ${GREEN}5.${NC} ./build.sh"
echo